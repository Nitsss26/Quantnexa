    ...
    <section id="case-studies" className="relative py-24 px-4 md:px-12 bg-black overflow-hidden border-b border-cyber-border/20">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="font-mono text-xs text-neon-green tracking-widest block mb-3 animate-pulse">PLATFORM PROOFS</span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between border-b border-cyber-border/20 pb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-mono text-[9px] text-cyber-text/50 tracking-wider">CASE FILE 0{idx+1}</span>
                    </div>
                  ...
                  <div className="space-y-3 font-mono text-[10px] pt-2">
                    ...
                    <div>
                      <span className="text-neon-emerald font-bold block">QUANTIFIABLE IMPACT:</span>
