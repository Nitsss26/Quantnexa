    ...
    <div className="w-full relative glass-panel rounded-xl overflow-hidden shadow-2xl border border-cyber-border/30 bg-black/30 backdrop-blur-md font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 py-3 bg-[#050b08] border-b border-cyber-border/30">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-cyber-text tracking-widest font-mono">AGRICONNECT - INTEL CORE v1.2</span>
        </div>
        ...
        <div className="md:col-span-6 flex flex-col gap-4">
          ...
          <div className="relative aspect-video rounded-lg border border-cyber-border/40 bg-[#020703] overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute bottom-2 right-2 font-mono text-[9px] text-neon-green bg-black/60 px-1.5 py-0.5 rounded border border-neon-green/20">
              {isScanning ? 'CALIBRATING...' : 'SCANNER READY'}
            </div>
          </div>
          ...
          <div className="relative mt-2">
            ...
            {!isScanning && !scanResult && (
              <div className="absolute -top-10 left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce pointer-events-none z-20">
                <span className="text-[9px] font-bold text-neon-emerald tracking-wider bg-black/90 px-2 py-0.5 rounded border border-neon-emerald/50 shadow-[0_0_10px_rgba(34,255,102,0.3)] whitespace-nowrap">CLICK HERE</span>
                <div className="w-0 h-0 border-l-[5px] border-r-[5px] border-t-[6px] border-transparent border-t-neon-emerald/80 mt-1"></div>
              </div>
            )}
            <button
              onClick={runCropScan}
        ...
        <div className="md:col-span-6 flex flex-col gap-4">
          ...
          <div className="p-4 bg-black/40 border border-cyber-border/20 rounded-lg flex-1 flex flex-col justify-between font-mono">
            {scanResult ? (
              <div className="space-y-2">
                <span className="text-[10px] text-neon-green/80 block">HEALTH REPORT GENERATED</span>
            ...
            <div className="mt-4 pt-3 border-t border-cyber-border/20">
              <span className="text-[9px] text-cyber-text/60 block mb-2 tracking-widest">SOIL CHEMICAL RATIO (NPK)</span>
          ...
          <div className="bg-[#050b08] border border-cyber-border/30 rounded-lg p-3 font-mono">
            <span className="text-[9px] text-cyber-text/50 block tracking-widest uppercase mb-1.5">
              LIVE AGRI MANDI TICKER (DELHI NCR)
            </span>
