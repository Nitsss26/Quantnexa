...
function TerminalPanel() {
  ...
  const rawLogs = [
    ...
    'SECURE TUNNEL - PINPOINTING P2P ROUTING PATHS...',
    ...
    'SECURITY SHIELD - SHA-256 E2EE ESTABLISHED',
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-cyber-border/20 flex items-center justify-between font-mono text-[8px] text-cyber-text/50">
        <div>
          <span className="block text-white/60 font-bold">LATENCY WAVEFORM</span>
        ...
        <div className="text-right">
          ...
          <span className="block text-[7px] text-cyber-text/30 mt-1">SSL - SHA256 ACTIVE</span>
        </div>
      </div>
    </motion.div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-5xl mx-auto relative z-10">
          ...
          >
            <div className="flex flex-col gap-1.5 mb-2 font-mono text-[9px] text-white/70 font-bold uppercase pl-1 select-none">
              <span>SYSTEM FEED DASHBOARD</span>
            </div>
            <TerminalPanel />
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-1.5 mb-2 font-mono text-[9px] text-white/70 font-bold uppercase pl-1 select-none">
              <span>SECURE PACKET MINTING PANEL</span>
            </div>
                  ...
                  >
                    ...
                    <div className="space-y-1.5 font-mono">
                      ...
                      <span className="text-[9px] text-cyber-text/50 uppercase tracking-wider block">
                        progress: {progress}% - WRITING ON TIMELINE
                      </span>
                    </div>
                  ...
                  >
                    ...
                    <div className="space-y-2 mt-2">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        className="w-full flex flex-col sm:flex-row items-center justify-center gap-2 py-3 text-[10px] sm:text-xs font-mono font-bold tracking-[0.15em] sm:tracking-[0.25em] text-black bg-gradient-to-r from-neon-emerald via-neon-green to-neon-emerald rounded-lg cursor-pointer shadow-[0_0_15px_rgba(34,255,102,0.25)] select-none transition-all duration-300 text-center"
                      >
