    ...
    <section id="blockchain" className="relative py-24 px-4 md:px-12 bg-black overflow-hidden border-b border-cyber-border/20">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="font-mono text-xs text-neon-green tracking-widest block mb-3 animate-pulse">TRUST INFRASTRUCTURE</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-5">
            <span className="font-mono text-xs text-cyan-400 tracking-wider block uppercase">LIVE CHAIN BLOCKS</span>
            ...
            <div className="space-y-4 relative">
              ...
              >
                ...
                <div className="font-mono text-[10px] space-y-1 w-full overflow-hidden">
                  <div className="flex justify-between items-center text-white">
                    <span className="font-bold">BLOCK HEIGHT: 2,492,109</span>
                    <span className="text-neon-emerald">CONSENSUS OK</span>
                  </div>
              ...
              >
                ...
                <div className="font-mono text-[10px] space-y-1 w-full overflow-hidden">
                  <div className="flex justify-between items-center text-white">
                    <span className="font-bold">BLOCK HEIGHT: 2,492,108</span>
                    <span className="text-cyan-400">CONSENSUS OK</span>
                  </div>
              ...
              >
                ...
                <div className="font-mono text-[10px] space-y-1 w-full overflow-hidden">
                  <div className="flex justify-between items-center text-white">
                    <span className="font-bold text-cyber-text/80">GENESIS BLOCK</span>
