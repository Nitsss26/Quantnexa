...
export default function StatusBadge({ status = 'LIVE', className = '' }) {
  ...
  return (
    <div
      className={`inline-flex items-center gap-2.5 px-3 py-1.5 rounded border glass-panel font-mono text-xs uppercase tracking-widest whitespace-nowrap ${config.color} ${config.bg} ${config.border} ${config.glow} ${className}`}
    >
