...
export default function AIScannerMockup() {
  ...
  const triggerGrading = () => {
    ...
    const interval = setInterval(() => {
      ...
      if (progress === 60) {
        setOcrText('COMPARING TO RUBRIC MODULE #MATH SEC A...');
    ...
    <div className="w-full relative glass-panel rounded-xl overflow-hidden shadow-2xl border border-cyber-border/30 bg-black/30 backdrop-blur-md font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 py-3 bg-[#050b08] border-b border-cyber-border/30">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-cyber-text tracking-widest font-mono">GRADE AI - OCR ENGINE v3.4</span>
        </div>
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        <div className="md:col-span-7 flex flex-col gap-4">
          <div className="text-xs font-mono text-neon-green/80 flex items-center justify-between">
            <span>ANSWER SHEET OCR SCANNER</span>
          ...
          <div className="relative p-4 rounded-lg border border-cyber-border/40 bg-[#020703] overflow-hidden min-h-[180px] font-mono text-xs">
            ...
            <div className="space-y-3 relative z-10">
              <div className="flex items-center gap-2">
                <span className="text-[9px] px-1 py-0.5 rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/30">Q1 BLOCK</span>
                <span className="text-cyber-text/50">EXTRACTED BOUNDING BOX:</span>
              </div>
          ...
          <div className="p-4 bg-black/40 border border-cyber-border/20 rounded-lg flex-1 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-1">
                <span className="text-[10px] text-cyber-text/60 tracking-wider block">AUTO FEEDBACK TRANSCRIPT</span>
