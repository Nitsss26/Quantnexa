...
const quantNexaLogo = '/assets/tech/QuantNexaLogoFinal.png';
      ...
      <AnimatePresence>
        {phase === 'brand' && !exiting && (
          ...
          >
            ...
            >
              <img src={quantNexaLogo} alt="QuantNexa" style={{ width: 'clamp(280px, 45vw, 550px)', height: 'auto', display: 'block' }} />
            </motion.div>
