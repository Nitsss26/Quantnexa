...
const METRICS = [
  { label: 'IIT trained Builders', value: '250+', sub: 'CORE ENGINEERS', icon: Flame, color: 'text-neon-green', border: 'border-neon-green/30' },
  { label: 'Enterprise Systems', value: '50+', sub: 'DEPLOYED PRODUCTION', icon: Server, color: 'text-cyan-400', border: 'border-cyan-400/30' },
  { label: 'Secure Requests Daily', value: '2M+', sub: 'SECURE P2P CALLS', icon: ShieldCheck, color: 'text-purple-400', border: 'border-purple-400/30' },
  { label: 'Custom Codebases', value: '100%', sub: 'ZERO TEMPLATES MINT', icon: Code, color: 'text-yellow-400', border: 'border-yellow-400/30' },
  { label: 'Partner Institutes', value: '30+', sub: 'INSTITUTES VERIFIED', icon: Building2, color: 'text-neon-emerald', border: 'border-neon-emerald/30' },
  { label: 'Reached Cities', value: '170+', sub: 'PAN BHARAT GRID', icon: MapPin, color: 'text-pink-400', border: 'border-pink-400/30' }
];
            ...
            return (
              ...
              >
                ...
                <div className="font-mono mt-auto">
                  <div className="text-xl sm:text-2xl font-black text-white tracking-tight group-hover:text-neon-green transition-colors text-center">
                    <AnimatedCounter value={metric.value} />
                  </div>
                  <div className="text-[9px] text-cyber-text/80 uppercase tracking-widest mt-0.5 leading-tight text-center">
                    {metric.label}
                  </div>
                </div>
              </motion.div>
